...
let goods = new Goods('Cherries', 27);
console.log(goods);
...
let goods2 = new Goods('Apple', 27, 'img/apple.png', 100);
goods2.draw();
...
let goods3 = new Goods2('Orange', 150, 'img/orange.png', 5, true);
goods3.draw();
...
let v = new Valid('energok3@gmail.com', '29809');
v.validate();
...
let w = new Valid('energok3@gmail.com', '123456');
w.validate();
...
let valid3 = new Valid2('energok3@gmail.com', 'vdfgdsf');
valid3.validate();
console.log(valid3);